# Åpne punkter i tilbudet

Alt som må fylles ut eller besluttes før `TILBUD.md` sendes. Markert
`‹AVKLARES›` i dokumentet.
...
## Vedlegg som må produseres

| Vedlegg | Innhold | Status |
|---|---|---|
