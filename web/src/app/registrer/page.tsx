...
function RegisterForm() {
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Klikk på lenken i e-posten for å bekrefte kontoen din og logge inn.
            </p>
  ...
  return (
    <div className="container flex min-h-[70vh] items-center justify-center py-8">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-center">Opprett konto</CardTitle>
          <CardDescription className="text-center">
            Registrer deg for å få tilgang til alle funksjoner
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Google login */}
